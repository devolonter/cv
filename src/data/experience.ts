export default [
  {
    ...
    responsibilities: [
      ...
      'Developed web applications using React while continuing to improve my skills and knowledge in the framework.'
    ],
  },
  {
    employer: 'Wild Pluto',
    ...
    responsibilities: [
      'Created a modular, multi-threaded game framework using Godot, resulting in improved performance and scalability.',
      'Participated in development 2 mobile match3 games, including the development of main game modules, and participated in the development and brainstorming of game mechanics and game ideas, resulting in engaging and innovative gameplay experiences.',
      ...
      'Implemented a module for inventory for Nakama server using Go lang, which provided a reliable and efficient inventory management system for players.',
